...
| Boundaries   | `npm run check:dep-cruiser` — required gate; `scripts/dependency-cruiser-known-violations.json` grandfathers pre-existing violations and is **empty** as of 2026-09-07, so every violation fails |
