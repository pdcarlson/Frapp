...
Read `Appendix: api-development.md` before working on the API.
...
#### Rule: Audit
Read `Appendix: audit.md` before performing any audit or quality review.
...
Read `Appendix: infrastructure-research.md` before investigating infrastructure state.
...
#### Rule: Testing
Read `Appendix: testing.md` before running tests, writing test cases, or verifying changes.
...
#### Rule: Ui Development
Read `Appendix: ui-development.md` before working on frontend code.
