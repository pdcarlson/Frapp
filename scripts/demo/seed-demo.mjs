...
/**
 * A one-page PDF naming the document and saying plainly that it is demo
 * content. Hand-built rather than generated by a dependency: the format needs
 * only five objects, and this script stays runnable before `npm install`.
 */
export function placeholderPdf(title) {
  const lines = [
    ["F1", 22, 700, title],
    ["F2", 12, 668, "Beta Theta Omega  ·  Westfield University"],
...
/** Every object under a folder, walking sub-folders (Storage lists one level). */
