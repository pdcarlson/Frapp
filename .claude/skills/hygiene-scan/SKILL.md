...
resolved by editing either side, even where
[`AGENTS.md` § Spec vs code](../../../AGENTS.md#spec-vs-code) would let an in-scope change fix the
stale side. A security or tenant-isolation bug is
