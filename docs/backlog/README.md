...
| [Analytics](projects/analytics.md) | active | [#431](https://github.com/pdcarlson/Frapp/issues/431) | pipeline (#464) shipped; opt-out toggle (#466) shipped (Settings → Privacy); salt mgmt (#465) queued |
