...
The docs checks run **elsewhere** — `.github/workflows/docs.yml`, covering structure, citations, references and rosters. None of them require a doc edit. Contract: [`docs/internal/ci-cd/DOCS_CI.md`](../internal/ci-cd/DOCS_CI.md).
