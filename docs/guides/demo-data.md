...
can take longer than that; the chapter still has events ahead then, just fewer each
day. Re-run steps 2 to 4. The login and its password persist, and `storage` overwrites the
