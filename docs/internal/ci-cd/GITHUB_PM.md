...
> contract reads or writes it. (Caveat until the owner finishes the wind-down: the still-connected
> Linear GitHub integration can touch it — see #680's checklist. The legacy Linear-named Routines
> are gone, checked 2026-09-22.)
>
