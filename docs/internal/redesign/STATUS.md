...
| 05  | Chat integrations + push                       | `claude/redesign-chunk-05-chat-integrations`    | in review    | —     | Sandbox blocked: Realtime / push / migration runtime checks — see [#235](https://github.com/pdcarlson/Frapp/issues/235). Predicate + worker rules fully covered by unit tests (chat-access, chat-authz pinning, push-rules, burst-bundler, chat-push-worker, chat-bridge-worker). |
