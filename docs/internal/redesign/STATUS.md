...
| 04  | Chat foundation + hot-path client              | `claude/redesign-chunk-04-chat-foundation`      | in progress  | —     | **Phase 0 (blocking security cluster) first**, on a separate branch `claude/chat-authz-hardening`: closes [#233](https://github.com/pdcarlson/Frapp/issues/233) [#234](https://github.com/pdcarlson/Frapp/issues/234) [#242](https://github.com/pdcarlson/Frapp/issues/242) [#243](https://github.com/pdcarlson/Frapp/issues/243) [#261](https://github.com/pdcarlson/Frapp/issues/261). Phase 1 (chat UI) starts once Phase 0 merges. |
