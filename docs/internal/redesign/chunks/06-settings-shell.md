...
1. `docs/internal/redesign/master-plan.md` — *Module catalog (revised)*, *Module gating*.
...
5. **Spec updates** — `spec/ui-web-dashboard.md` (settings rail + Org tab + Modules tab spec), `spec/product.md` (module catalog table).
