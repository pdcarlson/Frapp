...
| `pglite-migrations`  | Every migration applied from empty to PGlite, with the RLS posture asserted on the result (`scripts/check-pglite-migrations.mjs`); required since [#2538](https://github.com/pdcarlson/Frapp/issues/2538) |
