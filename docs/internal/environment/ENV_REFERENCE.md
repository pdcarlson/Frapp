...
| `RESEND_FROM_EMAIL` | _(leave empty → default `Signet <invites@frapp.live>`)_          | Override only if sending from a different verified domain                 | Override only if sending from a different verified domain                   |
...
| `RESEND_FROM_EMAIL`           | `modules/email/email.module.ts` (from-address override; default `Signet <invites@frapp.live>`)                                                                                                                                                                            | ❌       |
