...
| Report refused (403 / 404), form open | — | `This message can't be reported anymore. It may have been deleted, or you may no longer have access to where it was posted.` | `lib/chat/report-reasons.ts` (`reportFailureBody`) |
