...
> Normative companion to [ui/brand-identity.md](brand-identity.md). Defines **Frapp-owned** raster/SVG assets, where they live, and how apps consume them without drift.
...
Chapter accent color applies **inside chapter context** only per [ui/brand-identity.md](brand-identity.md) §3.
