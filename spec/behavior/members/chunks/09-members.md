...
1. `spec/redesign-context.md` — *Module catalog* (members is always-on).
...
4. **Spec updates:** `spec/ui-web-dashboard.md` (members surface + slideout + invite flow), `spec/behavior/members/README.md` (custom field visibility enforcement on server).
