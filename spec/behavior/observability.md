...
This file is the **product-behavior contract** for observability: which provider owns which signal, how identifiers correlate, what may leave the process, how releases are named, and how sampling is bounded. The **decision and rejected alternatives** live in [ADR-22](../architecture/README.md#adr-22-sentry-is-the-system-of-record-for-exceptions-and-traces-posthog-for-product-analytics). Pseudonymous identity, chapter opt-out, and account-deletion forget live in [`data-retention.md`](data-retention.md#analytics-events-pseudonymous). Operational routing lives in [`ALERT_ROUTING.md`](../../docs/internal/ops/ALERT_ROUTING.md). Env-var names live in [`ENV_REFERENCE.md`](../../docs/internal/environment/ENV_REFERENCE.md).
