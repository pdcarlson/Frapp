...
Human-only until proven otherwise: #709 (PostHog deleted-users automation), #1173 (production PostHog project), #863 (Sentry alert-rule *create* + channel proof), #970 (web DSN actually capturing), #938/#1361 (EAS + mobile DSN capture), source-map `SENTRY_AUTH_TOKEN` in Infisical `prod` (`staging` has carried it since 2026-09-18), network allowlists, production replay approval.
