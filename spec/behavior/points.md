...
hex>` label (`memberFallbackLabel`, `packages/hooks/src/display-names.ts`)
  ...
  left the chapter (see _Edge Cases_), and one who has never set a display name
