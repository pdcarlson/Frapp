...
- **Rate limiting:** A single admin cannot create more than N point adjustments per hour. Exceeding the limit returns 429 Too Many Requests. N is `chapter_points_config.adjustment_rate_limit_per_hour`, **default 50**.
