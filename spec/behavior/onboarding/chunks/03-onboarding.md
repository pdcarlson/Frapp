...
1. `spec/redesign-context.md` — section *Chapter directory & onboarding wizard*.
...
6. **Spec updates** — `spec/ui-web-dashboard.md` (wizard screen + flow, removal of `/home`), `spec/behavior/chat/README.md` (default channel seeding rule), `spec/behavior/onboarding/README.md` (manual-entry path captures a request row).
