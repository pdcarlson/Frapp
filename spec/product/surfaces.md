...
- **Chat first, and the page says so.** The hero leads on running the chapter where it already talks; the two proof sections are chat and events with check-in. Backwork, points and study hours are named on the Chapter Pro list rather than presented as co-equal headline features. The composition is [`spec/ui/landing/README.md`](../ui/landing/README.md) § Section inventory.
