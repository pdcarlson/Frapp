...
- Pricing: **both tiers**. The free tier — unlimited chat, members and chapters, no card — is the wedge and is stated on the page; Chapter Pro is a flat monthly per-chapter plan. Amounts and what each tier gates are [`positioning.md`](positioning.md), which is canonical; the page sells them and does not set them.
