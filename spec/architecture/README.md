...
- Claude Code exposes a supported way to invoke `/code-review` programmatically (or drops the author lock) → retire `/diff-review` and point the hook back at the bundled reviewer.
