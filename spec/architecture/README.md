...
- OAuth quota contention with interactive work, or unacceptable Actions-minute cost → add a `paths:` filter, throttle on-demand reviews, or move to the managed Code Review service if Frapp lands on a Team/Enterprise plan.
