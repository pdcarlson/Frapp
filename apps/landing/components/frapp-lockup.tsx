 ...
 *     reskin is most likely to break by accident, and on this surface the two
 *     values happen to be identical today (D1), which is exactly what would
 *     make the mistake invisible. It never takes theme or chapter accent.
 *
