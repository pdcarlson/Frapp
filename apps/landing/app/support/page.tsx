...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      "Push notifications are optional and can be turned on or off at any time from the app's Notifications settings, or from your device's system settings for Signet. Inside the app you can set quiet hours and choose which categories of notification you receive; muting an individual channel is done from the web dashboard.",
    ],
  },
  {
