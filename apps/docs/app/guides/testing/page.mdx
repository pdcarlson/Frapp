...
<Callout type="tip">
  Keep business logic in services small and focused. This makes unit tests much
...
<Callout type="warning">
  Do not chase 100% coverage at the expense of meaningful tests. Focus on
  critical business rules, security boundaries, and regressions we&apos;ve
  actually seen.
</Callout>
