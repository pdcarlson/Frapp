...
Create `.env.local` files for each app using these values. See <a href="https://github.com/pdcarlson/Frapp/blob/preview/docs/internal/ENV_REFERENCE.md"><code>docs/internal/ENV_REFERENCE.md</code></a> for the exact variables each app needs and their local values.
