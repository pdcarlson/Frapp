 ...
 * The compliance step.
 *
 * A deliberate friction point, not a technical control — Frapp cannot verify
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Importing brings your Discord history into Frapp, where every member of
      ...
      <p className="text-sm text-muted-foreground">
        ...
        history is being archived into Frapp, and give people a chance to
        object. Frapp cannot check that you did. This is on you.
      </p>
      ...
      <label className="flex cursor-pointer items-start gap-3 rounded-lg border border-border p-3 text-sm">
        ...
        <span>
          ...
          message history is being archived into Frapp.
        </span>
      </label>
    </div>
  );
