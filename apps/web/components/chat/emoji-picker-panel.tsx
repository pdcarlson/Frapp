 ...
 *
 * Not imported directly by anything but `emoji-picker.tsx`, which is the
 * boundary that keeps `frimousse` out of the chunk that gates first paint —
 * read the reasoning there before adding a second import of this file.
 */
