 ...
 * border half of `FOCUS_RING` conforms for every palette written since, and
 * the API's hourly stale-palette sweep recomputes any palette stored before it
 * (#1165, `accent-engine.md` §4). The guarantee is pinned in
