...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
       ...
       *     `--popover`, the same `#2A2621`), and a 50% dim composited over
       *     `--background` drops 16 of them under it (`#8B0000` 3.01 → 1.61,
       *     `#CC0000` 3.01 → 1.56; measured 2026-09-23, #2541). That is the
       *     same erasure that made the real `disabled` attribute wrong here.
       *
