...
export const DASHBOARD_NAV: NavSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Name, photo, quiet hours, tutorial replay.",
        status: "coming-soon",
        statusLabel: "Soon",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Custom roles, permission catalog, presidency transfer.",
        status: "coming-soon",
        statusLabel: "Soon",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Approve service entries and view reports.",
        status: "coming-soon",
        statusLabel: "Soon",
        requireAnyOf: ["service:log", "service:approve"],
      },
    ],
  },
  {
