...
export class FinancialController {
  ...
  @Post('invoices')
  @ApiOperation({ summary: 'Create an invoice for a member (Admin Only - TODO: RBAC)' })
  ...
  async payInvoice(@Req() req: RequestWithUser, @Param('id') id: string) {
    ...
    return {
      url: await this.financialService.generatePaymentLink(id, stripeCustomerId, successUrl, cancelUrl)
    };
  }
}
