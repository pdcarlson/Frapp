 ...
 * prevent: the two Stripe endpoints registered on 2026-08-27 enable only five
 * of these six, having been written down by hand and never updated when
 * `payment_intent.payment_failed` was added to the handler.
 */
