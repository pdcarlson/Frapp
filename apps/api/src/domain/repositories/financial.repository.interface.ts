import { FinancialInvoice, FinancialTransaction } from '../entities/financial.entity';

export const FINANCIAL_REPOSITORY = 'FINANCIAL_REPOSITORY';

export interface IFinancialRepository {
  // Invoices
  createInvoice(invoice: Omit<FinancialInvoice, 'id' | 'createdAt'>): Promise<FinancialInvoice>;
  updateInvoice(id: string, updates: Partial<FinancialInvoice>): Promise<FinancialInvoice>;
