  ...
  return (
    <ScreenShell title="Profile" subtitle="Your membership and chapter record.">
      ...
      {!chapterId ? (
        ...
        // dash forever with nothing explaining why. Production tokens still
        // lack an `active_chapter_id` claim (empty prod / playbook, not a
        // disabled hook), so this is the common case in production rather than
        // an edge one.
