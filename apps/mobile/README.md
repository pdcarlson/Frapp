...
Create `.env.local` with the required variables. See [`docs/internal/environment/ENV_REFERENCE.md`](../../docs/internal/environment/ENV_REFERENCE.md) for the complete list and values per environment, and [`docs/mobile/testing.md`](../../docs/mobile/testing.md) for the full device-run walkthrough.
