...
**Display name:** chrome (home screen, iOS Settings, listing Name field) is
**Signet**. Bundle id (`live.frapp.mobile`), slug, scheme, and every public URL
stay **frapp** until the deferred rename. App Store uniqueness and USPTO remain
on #1829 / #1901 — this file is the listing paste, not the trademark search.
