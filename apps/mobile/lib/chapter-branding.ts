 ...
 * forest-green one **3.34:1** (a palette stored before then paints its older,
 * darker fill until the stale-palette sweep recomputes it; `accent-engine.md`
 * §4). Step 11 measures 7.5–8.6:1 on `--card` for every
